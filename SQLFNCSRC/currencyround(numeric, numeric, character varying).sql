-- Function: currencyround(DECFLOAT(34), DECFLOAT(34), character varying)

-- DROP FUNCTION currencyround(DECFLOAT(34), DECFLOAT(34), character varying);

CREATE OR REPLACE FUNCTION currencyround(
    p_amount DECFLOAT(34),
    p_curto_id DECFLOAT(34),
    p_costing character varying)
  RETURNS DECFLOAT(34)
$BODY$
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION currencyround(DECFLOAT(34), DECFLOAT(34), character varying)
  OWNER TO adempiere;
