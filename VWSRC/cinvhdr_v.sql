...
JOIN cpaytrm pt ON i.c_paymentterm_id = pt.c_paymentterm_id
JOIN cpaytrmt pt ON i.c_paymentterm_id = pt.c_paymentterm_id
...
JOIN adclntinf ci ON i.ad_client_id = ci.ad_client_id
