...
-- DROP VIEW rv_fact_acct_day;
 ...
 SELECT fact_acct.ad_client_id,
    ...
    firstof(fact_acct.dateacct, 'DD') AS dateacct,
    ...
    sum(fact_acct.amtacctdr - fact_acct.amtacctcr) AS amtacct,
        CASE
            ...
            ELSE sum(fact_acct.amtacctdr - fact_acct.amtacctcr) / 
			sum(fact_acct.amtsourcedr - fact_acct.amtsourcecr)
        END AS rate,
  ...
  (firstof(fact_acct.dateacct, 'DD')), fact_acct.c_period_id, fact_acct.gl_category_id, fact_acct.gl_budget_id,
  fact_acct.c_tax_id, fact_acct.m_locator_id, fact_acct.postingtype, fact_acct.c_currency_id, 
  fact_acct.m_product_id, fact_acct.c_bpartner_id, fact_acct.ad_orgtrx_id, fact_acct.c_locfrom_id,
  fact_acct.c_locto_id, fact_acct.c_salesregion_id, fact_acct.c_project_id, fact_acct.c_campaign_id,
  fact_acct.c_activity_id, fact_acct.user1_id, fact_acct.user2_id, fact_acct.user3_id, 
  fact_acct.user4_id, fact_acct.a_asset_id;
