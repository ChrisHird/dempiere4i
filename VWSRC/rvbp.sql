...
-- DROP VIEW rv_bpartner;
 ...
 SELECT bp.ad_client_id,
   ...
   FROM c_bpartner bp
JOIN cbploc l ON bp.c_bpartner_id = l.c_bpartner_id AND l.isactive = 'Y'
     LEFT JOIN ad_user c ON bp.c_bpartner_id = c.c_bpartner_id AND (c.c_bpartner_location_id IS NULL 
	 OR c.c_bpartner_location_id = l.c_bpartner_location_id) AND c.isactive = 'Y'
