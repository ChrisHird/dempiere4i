...
-- DROP VIEW rv_c_invoice_month;
 ...
 SELECT rv_c_invoiceline.ad_client_id,
    ...
    firstof(rv_c_invoiceline.dateinvoiced, 'MM') AS dateinvoiced,
  ...
  (firstof(rv_c_invoiceline.dateinvoiced, 'MM')), rv_c_invoiceline.issotrx, 
  rv_c_invoiceline.c_bpartner_id, rv_c_invoiceline.c_bp_group_id, rv_c_invoiceline.c_doctypetarget_id, 
  rv_c_invoiceline.docstatus;
