...
-- DROP VIEW rv_c_invoice_productmonth;
 ...
 SELECT il.ad_client_id,
  ...
  GROUP BY il.ad_client_id, il.ad_org_id, il.m_product_id, (firstof(il.dateinvoiced, 'MM')),
  il.issotrx, il.c_bpartner_id, il.c_bp_group_id, il.c_doctypetarget_id, il.docstatus, 
  il.m_product_class_id, il.m_product_group_id, il.m_product_classification_id, il.m_product_category_id;
