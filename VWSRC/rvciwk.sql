...
-- DROP VIEW rv_c_invoice_week;
 ...
 SELECT rv_c_invoiceline.ad_client_id,
    ...
    firstof(rv_c_invoiceline.dateinvoiced, 'DY') AS dateinvoiced,
  ...
  (firstof(rv_c_invoiceline.dateinvoiced, 'DY')), rv_c_invoiceline.issotrx, rv_c_invoiceline.c_bpartner_id, 
