...
-- DROP VIEW rv_c_invoice_customerprodqtr;
 ...
 SELECT il.ad_client_id,
  ...
  (firstof(il.dateinvoiced, 'Q')), il.issotrx, il.c_bp_group_id, il.c_doctypetarget_id, 
  il.docstatus, il.m_product_class_id, il.m_product_group_id, il.m_product_classification_id;
