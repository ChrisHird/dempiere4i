...
JOIN cordln l ON o.c_order_id = l.c_order_id
  WHERE o.docstatus = 'CO' AND o.isdelivered = 'N' AND (o.c_doctype_id IN ( SELECT c_doctype.c_doctype_id
		  ...
		  AND o.deliveryrule <> 'M' AND (l.m_product_id IS NULL OR (EXISTS ( SELECT p.m_product_id,
            p.ad_client_id,
            p.ad_org_id,
            p.isactive,
            p.created,
            ...
            p.copyfrom
           FROM m_product p
          WHERE l.m_product_id = p.m_product_id AND p.isexcludeautodelivery = 'N'))) AND l.qtyordered <> 
		  l.qtydelivered AND o.isdropship = 'N' AND (l.m_product_id IS NOT NULL OR l.c_charge_id IS NOT NULL)
		  AND NOT (EXISTS ( SELECT iol.m_inoutline_id,
            iol.ad_client_id,
            iol.ad_org_id,
            iol.isactive,
            iol.created,
...
FROM miolnma iol
          ...
          WHERE iol.c_orderline_id = l.c_orderline_id AND (io.docstatus = ANY (ARRAY['IP', 'WC']))))
  GROUP BY o.ad_client_id, o.ad_org_id, o.c_bpartner_id, o.c_order_id, o.documentno, o.dateordered, 
  o.c_doctype_id, o.poreference, o.description, o.salesrep_id, l.m_warehouse_id;
